...
parser.add_argument('--paraboloidout', default=False,
                   help='Replaces the output layer with paraboloid neuron layer instead of inserting before it')
...
def main():
    ...
    if (args.paraboloidout):
        ...
        #optimizer = gpt.GeoNDSGD(model.parameters(), lr = 0.1, weight_decay = 5e-4, momentum = 0.1, nesterov = False)# 78.96
        #optimizer = gpt.GeoNDSGD(model.parameters(), lr = 0.1, weight_decay = 5e-4, momentum = 0.2, nesterov = False)# 78.82
        #optimizer = gpt.GeoNDSGD(model.parameters(), lr = 0.1, weight_decay = 5e-4, momentum = 0.4, nesterov = False)# 79.12
        #optimizer = gpt.GeoNDSGD(model.parameters(), lr = 0.1, weight_decay = 5e-4, momentum = 0.8, nesterov = False)# 78.87
        #optimizer = gpt.GeoNDSGD(model.parameters(), lr = 0.1, weight_decay = 5e-4, momentum = 0.5, nesterov = False)# 79.14
        #optimizer = gpt.GeoNDSGD(model.parameters(), lr = 0.1, weight_decay = 5e-4, momentum = 0.6, nesterov = False)# 79.37
        optimizer = gpt.GeoNDSGD(model.parameters(), lr = 0.1, weight_decay = 5e-4, momentum = 0.7, nesterov = False)# 79.56
        #optimizer = gpt.GeoNDSGD(model.parameters(), lr = 0.1, weight_decay = 5e-4, momentum = 0.9, nesterov = False)# 77.46
        
        #optimizer = gpt.GeoNDSGD(model.parameters(), lr = 0.1, weight_decay = 5e-4, momentum = 0.5, nesterov = True)# 79.32
        #optimizer = gpt.GeoNDSGD(model.parameters(), lr = 0.1, weight_decay = 5e-4, momentum = 0.6, nesterov = True)# 79.32
        #optimizer = gpt.GeoNDSGD(model.parameters(), lr = 0.1, weight_decay = 5e-4, momentum = 0.7, nesterov = True)# 79.44
        #optimizer = gpt.GeoNDSGD(model.parameters(), lr = 0.1, weight_decay = 5e-4, momentum = 0.9, nesterov = True)
